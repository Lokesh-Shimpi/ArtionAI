        ...
        >
          <h1 className="text-4xl md:text-5xl font-semibold text-white leading-tight">
            ...
            <span className="bg-clip-text text-blue-400 font-semibold bg-gradient-to-r from-blue-400 to-blue-600">
              Powered by <span className='text-blue-500'>Artion A!</span>
            </span>
            </div>
          </h1>

          <p className="text-base  font-normal text-gray-400 max-w-2xl mx-auto">
            Simply think, write prompt, create your website in seconds with
            <span className="text-blue-400 font-semibold"> ArtionAI </span>
          </p>
        </motion.div>
